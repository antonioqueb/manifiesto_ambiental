...
class ManifiestoAmbiental(models.Model):
    ...
    no_exterior = fields.Char(related='partner_id.street_number')
    no_interior = fields.Char(related='partner_id.street_number2')
    colonia = fields.Char(related='partner_id.l10n_mx_edi_colony')
